...
namespace Generic_List
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Listede kaç tane eleman var : count
            Console.WriteLine(renkListesi.Count);
            Console.WriteLine(sayiListesi.Count);
 
            //elemanları ekrana yazdırma : foreach ve ListForeach ile elemanlara erişim
            ...
            Kullanıcılar kullancı1 = new Kullanıcılar();
            kullancı1.Isim = "Ayşe";
            kullancı1.Soyisim = "Yılmaz";
            kullancı1.Yas = 26;
